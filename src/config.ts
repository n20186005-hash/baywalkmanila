export const SITE = {
  ...
  googleMapsShortLink:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15447.224558!2d120.97736!3d14.57343!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397ca2e8fd22f33%3A0xba468a2e8b02c858!2sBaywalk%2C%20Roxas%20Blvd%2C%20Malate%2C%20Manila%2C%201004%20Metro%20Manila!5e0!3m2!1sen!2sph!4v1',
  ga4Id: 'G-HXM22WWPKP',
};
...
export const TRANSPORT_INFO = {
  lrt: [
    {
      line: 'LRT-1 (Roosevelt – Baclaran)',
      station: 'Pedro Gil Station',
      walk: '5 – 7 min walk westward toward the bay along Pedro Gil St',
    },
    {
      line: 'LRT-1',
      station: 'United Nations Avenue Station',
      walk: '10 – 12 min walk along UN Ave toward Roxas Blvd',
    },
    {
      line: 'LRT-1',
      station: 'Vito Cruz Station',
      walk: '15 – 20 min walk south to the CCP end of Baywalk',
    },
  ],
  jeepney: [
    { routes: ['Malate', 'Pier South via Mabini', 'Baclaran – Dapitan via Mabini'], tips: 'Ask the driver to drop you at "Roxas Blvd / Malate" then walk to the bay.' },
  ],
  taxi: {
    fromMakati: 'Grab or metered taxi. Budget PHP 150 – 250 depending on traffic.',
